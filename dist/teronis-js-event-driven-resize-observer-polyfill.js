(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@teronis-js/event-dispatcher"));
	else if(typeof define === 'function' && define.amd)
		define("EventDrivenResizeObserver", ["@teronis-js/event-dispatcher"], factory);
	else if(typeof exports === 'object')
		exports["EventDrivenResizeObserver"] = factory(require("@teronis-js/event-dispatcher"));
	else
		root["Teronis"] = root["Teronis"] || {}, root["Teronis"]["EventDrivenResizeObserver"] = factory(root["Teronis"]["EventDispatcher"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE__teronis_js_event_dispatcher__) {
...
function () {
  function EventDrivenResizeObserver() {
    ...
    this.resizeObserver = new resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_1__["default"](this.handleResize);
  ...
  _createClass(EventDrivenResizeObserver, [{
    ...
    value: function observe(target, callback) {
      ...
      var eventWithTarget = this.getEventByTarget(target); // prepare if first callback of target
...
/*!*********************************************************************************************************************************************************************************!*\
  !*** external {"commonjs":"@teronis-js/event-dispatcher","commonjs2":"@teronis-js/event-dispatcher","amd":"@teronis-js/event-dispatcher","root":["Teronis","EventDispatcher"]} ***!
  \*********************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE__teronis_js_event_dispatcher__;
